...
import type {
  DestinationBridge,
  DestinationBridgeInterface,
} from "../DestinationBridge";
...
export class DestinationBridge__factory {
  static readonly abi = _abi;
  static createInterface(): DestinationBridgeInterface {
    return new Interface(_abi) as DestinationBridgeInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): DestinationBridge {
    return new Contract(address, _abi, runner) as unknown as DestinationBridge;
  }
}
