...
import type { SourceBridge, SourceBridgeInterface } from "../SourceBridge";
...
const _abi = [
    ...
    inputs: [
      {
        indexed: true,
        internalType: "address",
        name: "oldWrappedNative",
        type: "address",
      },
      {
        indexed: true,
        internalType: "address",
        name: "newWrappedNative",
        type: "address",
      },
    ],
    name: "NewWrappedNative",
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "_minAmountForNative",
        type: "uint256",
      },
      {
        internalType: "address",
        name: "_otherChainTokenForNative",
        type: "address",
      },
      {
        internalType: "address",
...
export class SourceBridge__factory {
  static readonly abi = _abi;
  static createInterface(): SourceBridgeInterface {
    return new Interface(_abi) as SourceBridgeInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SourceBridge {
    return new Contract(address, _abi, runner) as unknown as SourceBridge;
  }
}
