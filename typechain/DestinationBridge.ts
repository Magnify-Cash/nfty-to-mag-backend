...
export interface DestinationBridgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "RELAYER_ROLE"
  ...
  encodeFunctionData(functionFragment: "nonceInfo", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "nonceIsUsed", values: [string]): string;
  encodeFunctionData(
...
export interface DestinationBridge extends BaseContract {
  connect(runner?: ContractRunner | null): DestinationBridge;
  waitForDeployment(): Promise<this>;

  interface: DestinationBridgeInterface;
  ...
  nonceIsUsed: TypedContractMethod<[arg0: string], [boolean], "view">;
  ...
  filters: {
    ...
    "Refund(address,address,uint256,string)": TypedContractEvent<
      RefundEvent.InputTuple,
      RefundEvent.OutputTuple,
      RefundEvent.OutputObject
    >;
    ...
    "Send(address,address,address,uint256,uint256)": TypedContractEvent<
      SendEvent.InputTuple,
      SendEvent.OutputTuple,
      SendEvent.OutputObject
    >;
    ...
    "Withdraw(address,address,address,uint256,string)": TypedContractEvent<
      WithdrawEvent.InputTuple,
      WithdrawEvent.OutputTuple,
      WithdrawEvent.OutputObject
    >;
